...
<?php
    $conn = new mysqli('localhost', 'root', '', 'dis');

    if (isset($_POST['save'])) {

      $conn->query("INSERT INTO ratings (subject_title,semester,year,course,univ_roll,rating) VALUES ($subject_title,$semester,$year,$course,$univ_roll,'$ratedIndex')");
